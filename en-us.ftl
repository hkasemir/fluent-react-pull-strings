...
CityDetails_newLocationButton = 
     ...
     - check the component with the localization ID "CityDetails_newLocationButton"
...
CityDetails_newLocationButton4 = 
     STRING_IMPORT_ERROR: no translated props or message provided to UreactButton
     - add a "data-translated-props" array with the propNames of the DOM Attributes to be translated
     - or pass in a non-empty translatable message as a child
     - check the component with the localization ID "CityDetails_newLocationButton4"
